...
export default function NowPlaying() {
  ...
  return (
    <div className="fixed top-4 left-1/2 z-[1002] -translate-x-1/2">
      <a
        href={track.songUrl}
        target="_blank"
      ...
      >
        ...
        <div className="flex flex-col">
          <span className="flex items-center gap-1.5 text-[11px] text-[var(--color-fg-tertiary)]">
            <span
          ...
          <span className="max-w-[160px] truncate text-[11px] text-[var(--color-fg-primary)] group-hover:underline">
